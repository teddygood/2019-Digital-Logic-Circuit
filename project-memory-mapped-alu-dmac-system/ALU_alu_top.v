module ALU_alu_top(clk, reset_n, alu_begin, o_empty, o_rd_err, o_rd_ack, o_dout, r_full, r_wr_err, r_wr_ack, rData, o_pop, r_push, alu_done, re, rAddr, wData, state, operand1, operand2, result2, result1);
	input clk, reset_n;
	input alu_begin;
