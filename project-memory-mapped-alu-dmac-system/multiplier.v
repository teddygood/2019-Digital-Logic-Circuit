 module multiplier(clk, reset_n, multiplier, multiplicand, op_start, op_clear, op_done, result);
	...
	cla128 cla128_1(product, {first_multiplier, 64'h0000_0000_0000_0000}, 1'b0, add_product, add_co); //co of cla is not needed
	ASR128 ASR128_2(add_product, add_shift_product); //set value to added and shifted product
	cla64 cla64_1(~first_multiplier, 64'h0000_0000_0000_0000, 1'b1, minus_multiplier, minus_co); //co of cla is not needed
	cla128 cla128_2(product, {minus_multiplier, 64'h0000_0000_0000_0000}, 1'b0, sub_product, sub_co); //co of cla is not needed
	ASR128 ASR128_3(sub_product, sub_shift_product); //set value to subtracted and shifted product
	
	cla8 cla8_1(count, 8'b0000_0001, 1'b0, add_count, add_count_co); //set value to added count (co of cla is not needed)
